...
import { signOut, registerInternalNavIntent } from "./authService.js";

// 1. Inject Styles immediately in browser environment
            ...
            const desktopSidebarHtml = `
                <aside data-shell-element="true" class="desktop-sidebar fixed top-0 left-0 bottom-0 h-screen w-[240px] bg-white border-r border-[#E2E8F0] z-40 flex flex-col justify-between p-4 select-none">
                    ...
                    <div class="pt-4 border-t border-[#E2E8F0]">
                        <button onclick="handleLogout()" class="w-full flex items-center gap-3.5 px-4 py-3 rounded-xl text-[#64748B] hover:text-[#DC2626] hover:bg-red-50 text-sm font-medium transition-colors cursor-pointer">
...
// Initial render & viewport listener in browser environment
